 ...
 <div class="content"> <!-- =========== КОНТЕНТ =========== --> 
    ...
    <div class="centerbar"> 
	   ...
	   <div class="page_title_wrap">
	      <h1 class="page_title"><?php if (function_exists('breadcrumbs')) breadcrumbs(); ?>
	      </h1>
	   ...
	   <div class="trainings_wrap">
          ...
          $args = array( 'category_name' => 'blog', 'numberposts' => 0, 'paged'=> get_query_var('paged'),  'orderby'=>'date', 'order'=>'DESC' ); 
