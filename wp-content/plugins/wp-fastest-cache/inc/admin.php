				...
				<div class="tabGroup">
				    ...
				    <div class="tab6" style="padding-left:20px;">
						...
						<div class="wpfc-exclude-item" prefix="" content="" style="display:none;">
		    				...
		    				<div class="app home" style="float:left;display:none;">
		    					<div style="color: #555;font-size:14px;"><label style="color: #555;font-size:14px;" class="wpfc-exclude-item-prefix"></label> <label style="color: #555;font-size:14px;display:none;" class="wpfc-exclude-item-content"></label></div>
		    				</div>
